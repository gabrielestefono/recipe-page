  ...
  <main>
    <article>
      ...
      <section>
        ...
        <ol>
          <li>
            <h3 class="text-preset-04-bold">Beat the eggs</h3>
            <p class="text-preset-04">
          ...
          <li>
            <h3 class="text-preset-04-bold">Heat the pan</h3>
            <p class="text-preset-04">
              Place a non-stick frying pan over medium heat and add butter or oil.
            </p>
          </li>
          <li>
            <h3 class="text-preset-04-bold">Cook the omelette</h3>
            <p class="text-preset-04">
          ...
          <li>
            <h3 class="text-preset-04-bold">Add fillings (optional)</h3>
            <p class="text-preset-04">
          ...
          <li>
            <h3 class="text-preset-04-bold">Fold and serve</h3>
            <p class="text-preset-04">
          ...
          <li>
            <h3 class="text-preset-04-bold">Enjoy</h3>
            <p class="text-preset-04">Serve hot, with additional salt and pepper if needed.</p>
          </li>
        </ol>
      </section>
      <section>
